...
public:
    ...
    uint8_t popcount() const {
        return _mm_popcnt_u64(_mm256_extract_epi64(chunks, 0)) 
            + _mm_popcnt_u64(_mm256_extract_epi64(chunks, 1)) 
            + _mm_popcnt_u64(_mm256_extract_epi64(chunks, 2)) 
            + _mm_popcnt_u64(_mm256_extract_epi64(chunks, 3));
    }
